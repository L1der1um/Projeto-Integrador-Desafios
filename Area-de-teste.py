...
class Software:
    ...
    def criar_tela9(self):
        ...
        #TEXTO INFORMATIVO DE TELA
        label6 = tk.Label(self.tela9, text="Densidade" ,font=('Arial', 14, 'bold'))
        label6.pack(pady=40)

        #TEXTO INFORMATIVO DE TELA
        label61 = tk.Label(self.tela9, text="Insira zero (0) dentro do dado que você deseja calcular")
        label61.pack(pady=20)
        ...
        label_densidade = tk.Label(self.tela9, text="Densidade (kg/m³): ")
        label_densidade.pack()

        entry_densidade = ttk.Entry(self.tela9)
        ...
        label_massac = tk.Label(self.tela9, text="Massa (kg):")
        label_massac.pack()

        entry_massac = ttk.Entry(self.tela9)
        ...
        #TEXTO VOLUME
        label_volumec = tk.Label(self.tela9, text="Volume (m³):")
        label_volumec.pack()

        entry_volumec = ttk.Entry(self.tela9)
        ...
        #TEXTO PARA INFORMAR O RESULTADO DA OPERAÇÃO
        resultado = tk.StringVar()
        label_resultado = tk.Label(self.tela9, textvariable=resultado)
        label_resultado.pack()
    ...
    def criar_tela10(self):
        ...
        #TEXTO INFORMATIVO DE TELA
        label6 = tk.Label(self.tela10, text="Velocidade Média" ,font=('Arial', 14, 'bold'))
        label6.pack(pady=40)

        #TEXTO INFORMATIVO DE TELA
        label6 = tk.Label(self.tela10, text="Insira zero (0) dentro do dado que você deseja calcular")
        label6.pack(pady=20)
        ...
        label_velomedia = tk.Label(self.tela10, text="Velocidade média (m/s):")
        label_velomedia.pack()

        entry_velomedia = ttk.Entry(self.tela10)
        ...
        label_distanciap = tk.Label(self.tela10, text="Distância percorrida (m):")
        label_distanciap.pack()

        entry_distanciap = ttk.Entry(self.tela10)
        ...
        #TEXTO TEMPO
        label_tempo = tk.Label(self.tela10, text="Tempo (s):")
        label_tempo.pack()

        entry_tempo = ttk.Entry(self.tela10)
